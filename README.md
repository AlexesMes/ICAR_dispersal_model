...
* `tactical_sim_withoutplat.RData` contains the simulated data for the Wave of Advance simulation ("Section 3.3. The effect of the 800-400 BC calibration plateau" in the paper). Generated from the script `womble_model_tactical_cal.R` (found in the _scripts_ folder).
* `tactical_sim_withinplat.RData` contains the simulated data for the Wave of Advance simulation ("Section 3.3. The effect of the 800-400 BC calibration plateau" in the paper). Generated from the script `womble_model_tactical_cal.R` (found in the _scripts_ folder).
* `tactical_sim_withinplat_noerror.RData` contains the simulated data for the Wave of Advance simulation ("Section 3.3. The effect of the 800-400 BC calibration plateau" in the paper). Generated from the script `womble_model_tactical_uncal.R` (found in the _scripts_ folder).
...
| Hierarchical ICAR Model (Simulated, radiocarbon dates)| tactical_sim_withoutplat.RData        | womble_model_tactical_cal.R            | Womblemodel_tactical_withoutplat_errors.RData        |
| Hierarchical ICAR Model (Simulated, radiocarbon dates)| tactical_sim_withinplat.RData         | womble_model_tactical_cal.R            | Womblemodel_tactical_withplat_errors.RData           |
| Hierarchical ICAR Model (Simulated, calendar dates)   | tactical_sim_withinplat_noerror.RData | womble_model_tactical_uncal.R          | Womblemodel_tactical_withplat_noerrors.RData         |
